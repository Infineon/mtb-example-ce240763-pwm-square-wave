...
This code example generates a square wave using the PWM driver. An LED connected to the PWM output pin blinks at a frequency of 2 Hz. And these operations can also be performed in sleep mode.
...
The following example clones the "[mtb-example-ce240763-pwm-square-wave](https://github.com/Infineon/mtb-example-ce240763-pwm-square-wave)" application with the desired name "PWM_square_wave" configured for the *KIT_T2G_C-2D-6M_LITE* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_T2G_C-2D-6M_LITE --app-id mtb-example-ce240763-pwm-square-wave --user-app-name PWM_square_wave --target-dir "C:/mtb_projects"
   ```
...
4. After programming, the application starts automatically.  It enter the sleep mode. Confirm that "PDL: PWM Square Wave" is displayed on the UART terminal.

    **Figure 1.  Terminal output on program startup**

   ![Terminal Output](images/output_pwm_square_wave.png)

5. Confirm that the user LED on the kit blinks at half-second intervals (2 Hz).
...
**Table 1. Application resources**
 ...
 :---------- | :-------------- | :---------- 
 PWM         | TCPWM_PWM       | Generate a square wave and bring out the signal to GPIO 
 GPIO        | CYBSP_USER_LED  | User LED to show the PWM output 
...
Document title: *CE240763* – *PDL: PWM square wave* 
